		...
		<div class="inside">
				...
				<table border="0" width="96%" align="center"><tr>
					...
					<td><dcs:grid dataSource="<%= cooperativeGroupList %>" name="farmerGroupList" pageSize="<%=cooperativeGroupListForm.getDisplayRow()%>" width="100%">
						...
						<dcs:imagecolumn dataField="linkImageFarmerGroupEdit"  style="cursor:pointer;" headerText=""  width="40" HAlign="center" cssClass="manage-sr" onClick="addCooperativeGroupFarmer('{farmerGroupId}','{farmerGroupName}','{target}');"/>
						<dcs:imagecolumn dataField="linkImageEdit" style="padding-top:2px;cursor:pointer;"  headerText=""  width="40"  HAlign="center" cssClass="manage-sr" onClick="loadEdit('{farmerGroupId}','{farmerGroupName}');"/>
					</dcs:grid></td>
				<% } %></tr></table>
