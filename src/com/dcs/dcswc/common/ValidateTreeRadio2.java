...
public class ValidateTreeRadio2 extends AValidateTag implements IValidateTag {
	private static final long serialVersionUID = 8707755791097605450L;
	...
	public int doStartTag() throws JspException
    {
        ...
        if (objTmp==null)
            throw new JspException("Error: ValidateTreeRadio2 tag needs to be a child of ValidateForm!");
		...
		try {
			...
			objBuf.append("writeTreeRadio2('"+((HttpServletRequest)pageContext.getRequest()).getContextPath()+"','"+mstrName+"', document.all."+mstrName+"_div,[],[],[]);\n");
	...
	public int doEndTag() throws JspException
    {
        ...
        {
            throw new JspException("Error: ValidateTreeRadio2 is not a child of ValidateForm", CCEx);
        }
        finally
        {
	...
	private ValidateTreeRadio2 getCopy() {
		ValidateTreeRadio2 objItm = new ValidateTreeRadio2();
