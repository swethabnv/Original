...
public final class ImageLinkColumn extends AColumnTag
{
	private static final long serialVersionUID = 3560083391583091727L;

    public ImageLinkColumn()
    {
        super();
    }
 ...
 *----------------------------------------------------------------------------*/
    ...
    public void renderDetail(Object pobjValue) throws JspException
    {
        ...
        try
        {
            ...
            try 
            {
	            ...
	            if (blob.length()>0) {
	            	objBuf.append("<img src=\""+((HttpServletRequest)pageContext.getRequest()).getContextPath()+"/dcswc/images/imgicon.gif\" >");
	            }
	            if (this.mstrLinkUrl!=null) {
	            	objBuf.append("</a>");
	            }
    ...
    private ImageLinkColumn getCopy()
    {
        ImageLinkColumn objRet = null;

        objRet = new ImageLinkColumn();
