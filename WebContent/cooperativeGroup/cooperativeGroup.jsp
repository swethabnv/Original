...
<%@page import="com.wsnweb.form.CooperativeGroupForm"%>
...
#farmerGroupName { width: 370px !important; }
#objective { width: 355px !important; }
...
<% 
	...
	CooperativeGroupForm farmerGroup = (CooperativeGroupForm) request.getAttribute("CooperativeGroupForm");
	...
	List cooperativeGroupTeamList = (ArrayList) session.getAttribute("cooperativeGroupTeamList");
	String msg = "",cmd = "";
...
// IE
  $(document).ready(function() 
  {
    ...
    function loadData(){
        document.cooperativeGroupForm.cmd.value = "<%= cmd %>";
        document.cooperativeGroupForm.moo.value = "";
    <% if(!"".equals(cmd)){ %>
    	<% if(farmerId>0) { %>document.cooperativeGroupForm.farmerGroupId.value = "<%= farmerId %>";<% } %>
    	<% if(provinceNo>0) { %>
            document.cooperativeGroupForm.provinceNo.value = "<%=provinceNo%>";
            getDistrictInfo('provinceNo', 'districtNo', 'subDistrictNo', 'postCode');
        <% } %>
    	<% if(districtNo>0) { %>
            document.cooperativeGroupForm.districtNo.value = "<%=districtNo%>";
            getSubDistrictInfo('provinceNo','districtNo','subDistrictNo', 'postCode');
        <% } %>
    	<% if(subDistrictNo>0) { %>
            document.cooperativeGroupForm.subDistrictNo.value = "<%=subDistrictNo%>";
            getPostCodeInfo('provinceNo','districtNo','subDistrictNo', 'postCode');
        <% } %>
    	<% if(target>0) { %>
            document.cooperativeGroupForm.target.value = formatNumber("<%=target%>");
        <% } %>
        <% if("Edit".equals(cmd)){ %>
            //document.cooperativeGroupForm.farmerGroupName.readOnly = true;
            <% if(moo>0) {%>
                document.cooperativeGroupForm.moo.value = <%= moo %>;
            <% } %>
        <%}%>
    <% } %>
        showErrorMessage(); 
    ...
    function saveFarmerGroup(){
        ...
        if(document.cooperativeGroupForm.farmerGroupName.value == "" ){
            alert("กรุณาใส่ชื่อกลุ่ม !!");
            window.setTimeout(function () {
            document.cooperativeGroupForm.farmerGroupName.focus();
            }, 0);
            saveIs = false;
        }else if(document.cooperativeGroupForm.target.value == "" ){
            alert("กรุณาใส่จำนวนเป้าหมายของกลุ่ม !!");
            window.setTimeout(function () {
            document.cooperativeGroupForm.target.focus();
            }, 0);
            saveIs = false;
        }else if(document.cooperativeGroupForm.addressNo.value == "" ){
            alert("กรุณาใส่สถานที่ตั้งของกลุ่ม !!");
            window.setTimeout(function () {
            document.cooperativeGroupForm.addressNo.focus();
            }, 0);
            saveIs = false;
        }else if(document.cooperativeGroupForm.provinceNo.value == 0){
            alert("กรุณาเลือกจังหวัด !!");
            saveIs = false;
        }else if(document.cooperativeGroupForm.districtNo.value == 0){
            alert("กรุณาเลือกอำเภอ !!");
            saveIs = false;
        }else if(document.cooperativeGroupForm.subDistrictNo.value == 0){
            alert("กรุณาเลือกตำบล !!");
            saveIs = false;
        }
        if(saveIs){
        	document.cooperativeGroupForm.farmerGroupName.value = document.cooperativeGroupForm.farmerGroupName.value.trim();
            var target = document.getElementById('target');
            document.cooperativeGroupForm.target.value = target.value.replace(/,/g , "");

            document.cooperativeGroupForm.cmd.value="Save";
...
function checkFax(str) {
    ...
    function saveFarmerGroupTeam() {
    	...
    	var teamName = $("#teamFName").val()+" "+$("#teamLName").val();
    ...
    function getDistrictInfo(objPName, objDName, objSName, objPostCode)
    {
        ...
        if(provinceDD.options[provinceDD.selectedIndex].value==''){
            ...
            new Ajax.Request("<%=request.getContextPath()%>/CooperativeGroup.do",
            {
                method: 'post',
                asynchronous: false,
    ...
    function closePage(){
        document.cooperativeGroupListForm.farmerGroupName.value = "";
...
<body onload="loadData();">
	<dcs:validateForm formName="cooperativeGroupForm" formAction="CooperativeGroup.do" formBean="CooperativeGroupForm">
			...
			<div class="inside">
				<div class="content-keyin">
					<div class="search-header">
						<!-- <p>ข้อมูลสหกรณ์</p> -->
						&nbsp;&nbsp;&nbsp;<span style="vertical-align: -7px;color: white;" ><font class="topic" >ข้อมูลสหกรณ์</font></span>
					</div>
					<div class="clear"></div>
					<div class="line-input-keyin">
						<ul>
							<li class="topic" style="width: 100px;padding-right:0px">ชื่อสหกรณ์ :</li>
							<li class="topic" style="width: 1px;padding-right:5px"><font color="red">*</font></li>
							<li class="boxinput" style="width:380px">
								<dcs:validateText name="farmerGroupName" property="farmerGroupName" maxlength="100" />
							</li>
							<li class="topic" style="width: 70px;padding-right:0px">เป้าหมาย :</li>
							<li class="topic" style="width: 1px;padding-right:5px"><font color="red">*</font></li>
							<li class="boxinput" style="width:180px">
								<dcs:validateText name="target" property="target" maxlength="16" style="margin-top: 5px;" onChange="checkNumberComma(this);"/> &nbsp;กก.
							</li>
						</ul>
					</div>
					<div class="line-input-keyin">
						<ul>
							<li class="topic" style="width: 100px;padding-right:0px">สถานที่ตั้ง ที่อยู่ :</li>
							<li class="topic" style="width: 1px;padding-right:5px"><font color="red">*</font></li>
							<li class="boxinput" style="width:61px">
								<dcs:validateText  name="addressNo" property="addressNo" maxlength="50"/>
							</li>
							...
							<li class="boxinput" style="width:130px">
								<dcs:validateText  name="village" property="village" style="width:130px;" maxlength="30"/>
							</li>
							<li class="topic" style="width: 70px;padding-right:0px">ซอย :</li>
							<li class="topic" style="width: 1px;padding-right:5px"></li>
							<li class="boxinput" style="width:130px">
								<dcs:validateText  name="soi" property="soi" style="width:130px;" maxlength="30"/>
							</li>
							<li class="topic" style="width: 90px;padding-right:0px">ถนน :</li>
							<li class="topic" style="width: 0px;padding-right:5px"></li>
							<li class="boxinput" style="width:130px">
								<dcs:validateText  name="road" property="road" style="width:130px;" maxlength="30"/>
							</li>
						</ul>
					</div>
					<div class="line-input-keyin">
						<ul>
							<li class="topic"style="width:100px;padding-right:0px">จังหวัด :</li>
							<li class="topic" style="width: 1px;padding-right:5px"><font color="red">*</font></li>
							<li class="boxinput"style="width:150px">
								<select id="provinceNo" name="provinceNo" style="width:140px;" onChange="getDistrictInfo('provinceNo', 'districtNo', 'subDistrictNo', 'postCode');">
							...
							<li class="topic" style="width: 1px;padding-right:5px"><font color="red">*</font></li>
							<li class="boxinput"style="width:130px">
								<dcs:validateDropDown name="districtNo" dataSource="<%= districtList %>" property="districtNo" keyField="districtNo"  displayField="thaiName" style="width:140px;" onChange="getSubDistrictInfo('provinceNo','districtNo','subDistrictNo', 'postCode')" isRequire="true"/>
							</li>
							<li class="topic"style="width:70px;padding-right:0px">ตำบล :</li>
							<li class="topic" style="width: 1px;padding-right:5px"><font color="red">*</font></li>
							<li class="boxinput"style="width:130px">
								<dcs:validateDropDown name="subDistrictNo" dataSource="<%= subDistrictList %>" property="subDistrictNo" keyField="subDistrictNo"  displayField="thaiName"  isRequire="true" onChange="getPostCodeInfo('provinceNo','districtNo','subDistrictNo','postCode')" style="width:140px;"/>	
							</li>
							<li class="topic" style="width: 90px;padding-right:0px">รหัสไปรษณีย์ :</li>
							<li class="topic" style="width: 1px;padding-right:5px"></li>
							<li class="boxinput" style="width: 130px;">
								<dcs:validateText name="postCode" property="postCode" maxlength="5" style="width:130px" isReadOnly="true"/>
							</li>
						</ul>
					</div>
					<div class="line-input-keyin">
						<ul>
							<li class="topic" style="width: 100px;padding-right:0px">เบอร์โทรศัพท์ :</li>
							<li class="topic" style="width: 1px;padding-right:5px"></li>
							<li class="boxinput" style="width: 150px;">
								<dcs:validateText name="tel" property="tel" maxlength="30" onChange="checkTel(this)" style="width:130px;"/>
							</li>

							<li class="topic" style="width: 80px;padding-right:0px">เบอร์โทรสาร :</li>
							<li class="topic" style="width: 1px;padding-right:5px"></li>
							<li class="boxinput " style="width: 130px;">
								<dcs:validateText name="fax" property="fax" maxlength="30" onChange="checkFax(this)" style="width:130px;"/>
							</li>
						</ul>
					</div><br />
							...
							<table align="center" width="96%">
								<tbody>
									...
									<tr>
										...
										<tbody>
											<% if(cooperativeGroupTeamList!=null && cooperativeGroupTeamList.size()>0) { 
												for(int i=1;i<=cooperativeGroupTeamList.size();i++) {
													FarmerGroupTeam getItem = (FarmerGroupTeam)cooperativeGroupTeamList.get(i-1); %>
												<% if(i%2==1) { %>
...
<form name="cooperativeGroupListForm"  method="post" action="<%=request.getContextPath()%>/CooperativeGroupList.do">
